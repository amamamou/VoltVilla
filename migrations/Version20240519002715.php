 ...
 */
final class Version20240519002715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE intervention ADD note DOUBLE PRECISION DEFAULT NULL, CHANGE user_id code_clt_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE intervention DROP note, CHANGE code_clt_id user_id INT DEFAULT NULL');
